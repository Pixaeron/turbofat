...
func unload_dna() -> void:
	...
	_creature_visuals.rescale(1.00 * Creature.MAGIC_NUMBER_40936)
...
func load_dna() -> void:
	...
	_creature_visuals.rescale((0.60 if _creature_visuals.dna.get("body") == "2" else 1.00) * Creature.MAGIC_NUMBER_40936)
